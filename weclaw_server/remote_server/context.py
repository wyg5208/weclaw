...
def set_weclaw_bridge(bridge: Any):
    """设置 WeClaw 桥接器"""
    global _weclaw_bridge
    _weclaw_bridge = bridge


def get_weclaw_bridge() -> Optional[Any]:
    """获取 WeClaw 桥接器"""
    return _weclaw_bridge
...
def reset_all():
    ...
    global _connection_manager, _weclaw_bridge, _bridge_manager
