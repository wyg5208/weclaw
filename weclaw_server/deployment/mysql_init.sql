-- WeClaw Remote Server MySQL 数据库初始化脚本
-- 适用于 MySQL 8.0+

-- 创建数据库
CREATE DATABASE IF NOT EXISTS weclaw 
...
-- 创建专用用户 (生产环境推荐)
-- CREATE USER 'weclaw_app'@'%' IDENTIFIED BY 'YourStrongPassword123!';
-- GRANT SELECT, INSERT, UPDATE, DELETE ON weclaw.* TO 'weclaw_app'@'%';
-- FLUSH PRIVILEGES;

-- 完成提示
SELECT 'WeClaw MySQL 数据库初始化完成!' as message;
