# WeClaw Let's Encrypt Certificate One-Click Deployment Script
# Automatic: Application + Installation + Configuration + HTTPS Enablement

Write-Host "========================================" -ForegroundColor Cyan
Write-Host " WeClaw Let's Encrypt One-Click Deploy" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
