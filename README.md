...
- ✅ 修复 PDF 生成工具中 subprocess 调用找不到虚拟环境中 playwright 的问题
- ✅ 将硬编码的 "python" 改为 sys.executable，确保子进程使用正确的 Python 解释器

#### 技术经验记录 📖

- ✅ 新增技术经验文档：subprocess 使用 sys.executable 最佳实践
- ✅ 记录关键经验：subprocess 子进程应使用 sys.executable 而非硬编码 "python"
