...
Write-Host " WinClaw 证书状态检查" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "   D:\tools\win-acme\wacs.exe --target manual --host `"weclaw.cc,*.weclaw.cc`" --webroot `"D:\www\winclaw`" --store pemfiles --pemfilespath `"D:\nginx\ssl\weclaw.cc`" --accepttos" -ForegroundColor Gray
Write-Host ""
...
Write-Host "   Get-Content D:\nginx\logs\winclaw_https_error.log -Tail 50" -ForegroundColor Gray
Write-Host ""
