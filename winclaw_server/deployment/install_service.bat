@echo off
REM WinClaw Remote Server Windows 服务安装脚本
...
echo ========================================
echo  WinClaw Remote Server 服务安装脚本
echo ========================================
echo.
...
set "SERVICE_DISPLAY_NAME=WinClaw Remote Server"
set "SERVICE_DESCRIPTION=WinClaw 远程控制服务器 - 提供 API 和 WebSocket 服务"
...
"%NSSM_PATH%" set "%SERVICE_NAME%" AppEnvironmentExtra "WINCLAW_CONFIG=%PROJECT_ROOT%\config\remote_server.toml"
